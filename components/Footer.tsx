...
export const Footer = () => {
  return (<footer className='py-5 border-t-2 flex flex-col gap-2 justify-center place-items-center'>
    <div className="flex gap-3 text-3xl justify-center place-items-center">
  ...
  <span>Design & Development by Omer Gatenio | Frontend Developer</span>
</footer>)
}
